...
MovebleObject::MovebleObject(PMathO::Vec2D position, PMeshO::Mesh mesh, double mass = 1., double Frict = 1., PMathO::Vec2D speed = PMathO::Vec2D(0., 0.)) : Object(position, mesh), mass(mass), Frict(Frict), speed(speed) {}
